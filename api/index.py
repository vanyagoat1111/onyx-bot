...
NOSITE_MD = (
    ...
    "Чтобы разговор был предметным, вот три шага.\n\n"
    "### 1. Разбор по вашей отрасли\n"
    "Что должен делать сайт именно в вашей нише, с каким сомнением к вам "
    "приходит клиент и что это сомнение снимает. Здесь же ссылки "
    "на готовые сайты по отраслям.\n\n"
    "### 2. Чек-лист\n"
    "Что собрать до начала работы и о чём договориться с любым подрядчиком. "
    "Полезен, даже если работать будете не с нами.\n\n"
    "### 3. Персональный разбор\n"
...
def nosite_kb():
    rows = []
    # У человека без сайта первый вопрос не «как выбрать студию», а «что мне
    # вообще нужно». Поэтому разбор по нишам стоит выше чек-листа.
    if GUIDE_URL:
        rows.append([{"text": "🎯 Что должен делать сайт в моей нише", "url": GUIDE_URL}])
    if CHECKLIST_URL:
