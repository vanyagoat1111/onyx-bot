...
TARIFFS = [
    {"id": "start", "name": "Старт онлайн", "price": 9990,
    ...
    {"id": "leads", "name": "Сайт + заявки", "price": 14990, "best": True,
    ...
    {"id": "system", "name": "Сайт как система продаж", "price": 24990, "approx": True,
    ...
    if is_admin(uid) and text.startswith("/"):
        ...
        if low.startswith("/richtest"):
            ...
            demo = ("## ✅ Rich Messages работают\n\n"
                    ...
                    "| Старт онлайн | 9 990 ₽ | **0 ₽** |\n"
                    "| Сайт + заявки | 14 990 ₽ | **0 ₽** |\n"
                    "| Система продаж | от 24 990 ₽ | **0 ₽** |\n\n"
